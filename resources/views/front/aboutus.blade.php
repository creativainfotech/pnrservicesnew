    ...
    <div class="container">
        <div class="row">
            <div class="section-column image-section col-12 col-lg-5">
                <div class="image">
                    <img src="{{ url('/img/aboutus/5.jpg') }}" alt="" srcset="" class="img-fluid">
                </div>
            ...
            <div class="section-column rightSection col-12 col-lg-7 ps-4">
                ...
                <header>
                    ...
                    <div class="sectionTitle">PNR offers OEM experienced technical specialists</div>
                    <div class="line mx-0"></div>
                    <p class="content text-justify">PNR offers OEM experienced technical specialists to power generation
                        companies, oil & gas, fertilizers, cement industries. We supply our clients multi-disciplined
                        expertise with field engineers of electrical, mechanical, elctromechanical and instrumentation
                        disciplines.</p>
...
<section id="aboutus-highlighted-box">
    <div class="highlighted-card"><p class="">Customer satisfaction is our main <span>Focus</span>
    </p></div>
</section>
            ...
            <div class="row">
                ...
                <div class="section-column sectioninfo col-12 col-lg-8 pe-5">
                    ...
                    <header>
                        ...
                        <div class="sectionTitle">PNR works to develop long-term working relationships with suppliers.</div>
                        <div class="line mx-0"></div>
                        <p class="content text-justify"></p>We pride ourselves on our ability to provide flexibility while
                        ...
                        <div class="container-fluid ">
                            <div class="row">
                                <div class="section-column col-12 col-lg-4">
                                    <div class="image">
                                        <img src="{{ url('/img/aboutus/2.jpg') }}" alt="" srcset="" class="img-thumbnail">
                                    </div>
                                    {{-- <div class="overlay-card center-align">
                                        <p class="contentTitle text-white text-center">5 Year Of Working Experience</p>
                                        <p class="content text-white">We Crafted an aweso design library that is robust and intuitive to
                              ...
                              <div class="col-12 col-sm-8 pt-3">
                                <p class="content text-justify">Our skillful technical and procurement available resources make us uniquely positioned to be relied upon by many valued customers. </p>
                ...
                <div class="section-column image-section col-12 col-lg-4">
                    <div class="imagebox-rounded">
                        <img src="{{ url('/img/aboutus/4.jpg') }}" alt="" srcset="" class="img-fluid">
                    </div>
                    {{-- <div class="overlay-card center-align">
                        <p class="contentTitle text-white text-center">5 Year Of Working Experience</p>
                        <p class="content text-white">We Crafted an aweso design library that is robust and intuitive to
