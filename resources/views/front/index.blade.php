...
@section('mainSection')
    ...
    <div class="highlighted-box align-items-lg-center ">
        ...
        <h2 class="focused-content animate__animated animate__zoomIn animate__infinite"
    ...
    <section id="home-whychooseus" class="mainSection position-relative">
