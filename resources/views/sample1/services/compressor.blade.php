...
@section('bg-image')
    'img/services/compressor/compressor.jpg'
@endsection
...
@section('mainContent')
    ...
    <article class="row">
        <div class="col-12 col-lg-5 section-col-top-padding figure-section">
            <div class="image-box">
                <img src="{{ asset('img/services/compressor/Compressor Rotor Lift.jpg') }}" alt="" srcset="" class="">
            </div>
            {{-- <div class="row">
        ...
        <div class="col-12 col-lg-7 article-section">
            <header>
                <div class="subtitle">CENTRIFUGAL COMPRESSOR </div>
            </header>
            <p style="text-align: justify;">Major Overhauling and planned Maintenance of heavy-duty Centrifugal Compressors.  </p>
            {{-- <ul class="listbox">
    ...
    <article class="row bg-light">
        <div class="col-12 col-lg-7 article-section">
            <header>
                <div class="subtitle">RECIPROCATING & PD COMPRESSOR </div>
            </header>
            <p style="text-align: justify;">Major Overhauling, plunger Replacement, Troubleshooting’s, Valve Replacement and installation and commissioning of Reciprocating and PD Compressors. 

            </p>
        </div>
        <div class="col-12 col-lg-5 section-col-top-padding figure-section">
            <div class="image-box">
                <img src="{{ asset('img/services/compressor/Bell Mouth & Compressor Casing.jpg') }}" alt="" srcset="" class="">
            </div>
            {{-- <div class="row ">
                <div class="col-12 col-sm-6 ">
                    <div class="image-box">
