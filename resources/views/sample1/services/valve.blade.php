...
@section('mainContent')
    ...
    <article class="row">
        <div class="col-12 col-lg-5 section-col-top-padding figure-section">
            <div class="image-box">
                <img src="{{ asset('img/services/valve/valve2.jpg')}}" alt="" srcset="" class="">
            </div>
            {{-- <div class="row">
        ...
        <div class="col-12 col-lg-7 article-section">
            <header>
                <div class="subtitle">Valves</div>
            </header>
            <p style="text-align: justify;">Valve’s maintenance, Lapping, stem replacements, Glands Replacement, and complete overhauling of Gate Valves, Globe Valves, Ball Valves, Butterfly Valves, Check Valves, Pressure Valves, and Diaphragm Valves of industrial valves of major OEM’s.
            </p>
            {{-- <ul class="listbox">
