...
@section('bg-image')
    'img/services/gearbox/gearbox.jpg'
@endsection
...
@section('mainContent')
    ...
    <article class="row">
        ...
        <div class="col-12 col-lg-7 article-section">
            <header>
                <div class="subtitle">GEARBOXES</div>
            </header>
            <p style="text-align: justify;">Maintenance of INDUCTION and REDUCTION types of Gearboxes including complete Overhauling, Inspections, Troubleshooting , Installation and commissioning.</p>
            {{-- <ul class="listbox">
