...
@section('bg-image')
    'img/services/training/Trainings-1.jpg'
@endsection
...
@section('mainContent')
    ...
    <article class="row">
        ...
        <div class="col-12 col-lg-7 article-section">
            ...
            <p style="text-align: justify;">Our skillful technical and procurement available resources make us uniquely positioned to be relied upon by many valued customers. 
             </p>
            {{-- <ul class="listbox">
