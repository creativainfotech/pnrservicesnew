        ...
        <div class="container">
            ...
            <section>
                {{-- <style>
                    ...
                    .projects .section-content button.active {
                        color: #ffffff;
                        background-color: #555CE9;
                    }
                    ...
                    /* .gallery_product {
                        ...
                        .gallery_product:hover .overlayGalleryCard{
                            display: flex;
                        } */
                </style> --}}
        ...
        <div class="container">
            <section class="card-group-horizontal">
                ...
                {{-- <div class="image-card-vertical">
                    ...
                    <div class="card-content">
                        <p class="contentTitleSmall">REINIER KOORENHOF
                        </p>
                        <p class="content">Co-Founder & Technical Team Lead
                        </p>
                        <p class="content">Lorem ipsum dolor sit amet, diam felis maecenas lectus ac, volutpat arcu, urna
                            ac.
                            Vivamus dignissim sapien amet vivamu</p>
                ...
                <div class="image-card-vertical ">
                    ...
                    <div class="card-content">
                        <p class="contentTitleSmall">JUNAID ALI</p>
                        <p class="content">Co-Founder & Team Lead Services
                        </p>
                ...
                {{-- <div class="image-card-vertical ">
                    ...
                    <div class="card-content">
                        <p class="contentTitleBold">John Doe</p>
                        <p class="content">Founder - CEO</p>
                        <p class="content">Lorem ipsum dolor sit amet, diam felis maecenas lectus ac, volutpat arcu,
                            urna ac.
                            Vivamus dignissim sapien amet vivamu</p>
                    </div>
