...
<body onresize="move_circle()">
   <div class="preloader">
        <img src="{{ asset('') }}" alt="AdminLTELogo"
          height="60"
          width="60"
        />
      </div> 
                        ...
                        <ul class="navbar-nav mb-2 mb-lg-0">
                            ...
                            <li class="nav-item ">
                                <!-- <a class="btn buttonStyleSecondary" aria-current="page"
                                    href="{{ route('contact') }}" data-bs-toggle="modal" data-bs-target="#exampleModal">Get A Quote</a> -->
                                    <a class="btn buttonStyleSecondary" aria-current="page"
                                    href="" data-bs-toggle="modal" data-bs-target="#exampleModal">Get A Quote</a>
